          ...
          <table className='table-auto w-full'>
            ...
            <tbody>
              {querydata.class.students.map((student, index) => {
                return (
                  studentAttendance(student.id).map((attendance) => {
                    return (
                      <tr key={index} className='hover:bg-violet-300'>
                        <td className='p-2'>{index + 1}</td>
                        <td className='p-2'>{student.firstName}</td>
                        <td className='p-2 text-center'>{attendance.present}</td>
                        <td className='p-2 text-center'>{attendance.sick}</td>
                        <td className='p-2 text-center'>{attendance.permission}</td>
                        <td className='p-2 text-center'>{attendance.absent}</td>
